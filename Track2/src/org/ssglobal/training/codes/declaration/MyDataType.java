...
public class MyDataType {
	...
	public void literalConversion() { // Pascal Notation = LiteralConversion
...
class TestMyDataType {
	...
	public static void main(String[] args) {
		...
		MyDataType mdt2 = new MyDataType();
		System.out.println(MyDataType.PIE); //class variable		
		
		mdt.billGatesMoney = 20;
		System.out.println(mdt.hashCode());
		mdt2.billGatesMoney = 30;
		System.out.println(mdt2.hashCode());
